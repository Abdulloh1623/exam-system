# Generated by Django 6.0.2 on 2026-02-20 23:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(related_name='subjects', to='app.group')),
            ],
        ),
        migrations.CreateModel(
            name='Test',
            fields=[
                ...
                ('duration_minutes', models.PositiveIntegerField(default=30, verbose_name='Ajratilgan vaqt (minutda)')),
